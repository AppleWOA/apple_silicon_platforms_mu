# @file
# Script to Build MacBookPro Mu UEFI firmware 
# (this script is based off WOA-Project/SurfaceDuoPkg PlatformBuild.py)
#
# Copyright (c) Microsoft Corporation.
# SPDX-License-Identifier: BSD-2-Clause-Patent
#
# Modified copy of Platform/MacBookProEarly2023Pkg/PlatformBuild.py
##
import os
import logging
import io
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("MacBookProMid2021Pkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('MacBookPro', 'edk2-build', 'cibuild')
    WorkspaceRoot = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    PackagesPath = ("Platform", "MU_BASECORE", "Common/MU", "Common/TIANO", "Common/MU_OEM_SAMPLE", "Silicon/ARM/TIANO", "Common/MU_DFCI", "Silicon/Apple/AppleSiliconPkg", "Silicon/Apple/T600XFamilyPkg")
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("MacBookProMid2021Pkg/MacBookProMid2021.dsc", {})

    def GetName(self):
        return "MacBookProMid2021Pkg"
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "MacBookProMid2021", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "MacBookProMid2021Pkg/MacBookProMid2021.dsc", "Platform Hardcoded")
