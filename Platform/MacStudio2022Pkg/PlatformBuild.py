...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("MacStudio2021Pkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('MacStudio2021', 'edk2-build', 'cibuild')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("MacStudio2021Pkg/MacStudio2021.dsc", {})

    def GetName(self):
        return "MacStudio2021"
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "MacStudio2021", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "MacStudio2021Pkg/MacStudio2021.dsc", "Platform Hardcoded")
