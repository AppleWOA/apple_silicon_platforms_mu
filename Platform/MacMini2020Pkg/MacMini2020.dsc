...
[Defines]
  PLATFORM_NAME                  = MacMini2020
  PLATFORM_GUID                  = 1d0c231c-6c6f-4cbf-b147-da738f745bca
  PLATFORM_VERSION               = 1.0
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/MacMini2020-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacMini2020Pkg/MacMini2020.fdf
...
[PcdsFixedAtBuild.common]
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"Mac Mini (2020)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"Mac9,1"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"Mac Mini (Mac9,1)"
