# @file
# Script to Build Mac Mini (2020) Mu UEFI firmware 
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("MacMini2020Pkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('MacMini2020', 'gcc_aarch64_linux', 'edk2-build', 'cibuild')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("MacMini2020Pkg/MacMini2020.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "MacMini2020", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "MacMini2020Pkg/MacMini2020.dsc", "Platform Hardcoded")
