/** @file
  ...
  Copyright (c) 2022-2023 amarioguy
...
STATIC EFI_IMAGE_LOAD EfiLoadImage = NULL;
    ...
    IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
  ...
  EfiLoadImage = gBS->LoadImage;
  gBS->LoadImage = LoadImageWrapper;
  /**
   * Leave out the ExitBootServices patch right now
   * 
   */
