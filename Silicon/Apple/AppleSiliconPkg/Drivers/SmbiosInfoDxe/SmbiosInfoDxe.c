...
CHAR8 *mEnclosureInfoType3Strings[] = {"Apple Inc.", "Not Specified", "Not Specified", "Not Specified",
                                       NULL};
...
SMBIOS_TABLE_TYPE7 mCacheInfoType7_L1IC = {
    ...
    0x0140, // Maximum Size 320k
    0x0140, // Install Size 320k
    {
        // Supported SRAM Type
        0, // Other             :1
        0, // Unknown           :1
...
CHAR8 *mCacheInfoType7_L1IC_Strings[] = {"Combined L1 Instruction Cache", NULL};
...
SMBIOS_TABLE_TYPE7 mCacheInfoType7_L1DC = {
    ...
    1,      // SocketDesignation String
    0x0280, // Cache Configuration
    0x0c0, // Maximum Size 192k
    0x0c0, // Install Size 192k
    {
        // Supported SRAM Type
        0, // Other             :1
        0, // Unknown           :1
...
CHAR8 *mCacheInfoType7_L1DC_Strings[] = {"Combined L1 Data Cache", NULL};
...
SMBIOS_TABLE_TYPE7 mCacheInfoType7_L2C = {
    ...
    0x8100, // Maximum Size 16M, (64k * 256 pages)
    0x8100, // Install Size 16M
    {
        // Supported SRAM Type
        0, // Other             :1
        0, // Unknown           :1
...
CHAR8 *mCacheInfoType7_L2C_Strings[] = {"Combined L2 Cache", NULL};
...
/***********************************************************************
        SMBIOS data definition  TYPE7  Cache Information
************************************************************************/
//NOTE: M1 does not have traditional L3 cache, but the last level system cache is functionally
//identical
SMBIOS_TABLE_TYPE7 mCacheInfoType7_L3C = {
    {EFI_SMBIOS_TYPE_CACHE_INFORMATION, sizeof(SMBIOS_TABLE_TYPE7), 0},
    1,      // SocketDesignation String
    0x0282, // Cache Configuration
    0x8080, // Maximum Size 8M
    0x8080, // Install Size 8M
    {
        // Supported SRAM Type
        0, // Other             :1
        0, // Unknown           :1
...
CHAR8 *mCacheInfoType7_L3CStrings[] = {"L3/System Shared Cache", NULL};
...
SMBIOS_TABLE_TYPE19 mMemArrMapInfoType19 = {
    ...
    0,          // MemoryArrayHandle;
    0,          // PartitionWidth;
    0x800000000,          // ExtendedStartingAddress;
    0xA00000000,          // ExtendedEndingAddress;
};
...
VOID ProcessorInfoUpdateSmbiosType4(IN UINTN MaxCpus)
{
  ...
  LogSmbiosData(
      (EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L2C, mCacheInfoType7_L2C_Strings,
      &SmbiosHandle);
...
{
  LogSmbiosData(
      (EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L1IC, mCacheInfoType7_L1IC_Strings,
      NULL);
}
